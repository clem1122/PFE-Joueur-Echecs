"""
-- oracle_function : --
input: image1, image2, image echiquier vide, debug bool)
output: case origine, case destination (du coup joue par l'utilisateur)
Objectif: analyseer deux images prises avant et apres que l'utilisateur ait joue 
pour savoir quel coup il a joue et renvoyer les cases correspondantes.
"""
